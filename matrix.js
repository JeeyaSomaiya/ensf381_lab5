...
//Function to display the result of matrix operations
...
function addMatrices(matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        console.log("Matrix addition is not possible. Matrices must have the same dimensions.");
        return null;
    }
...
const subtractMatrices = function(matrix1, matrix2) {
    if (matrix1.length !== matrix2.length || matrix1[0].length !== matrix2[0].length) {
        console.log("Matrix subtraction is not possible. Matrices must have the same dimensions.");
        return null;
    }
...
const multiplyMatrices = (matrix1, matrix2) => {
    if (matrix1[0].length !== matrix2.length) {
        console.log("Matrix multiplication is not possible. Number of columns in the first matrix must be equal to the number of rows in the second matrix.");
        return null;
    }
